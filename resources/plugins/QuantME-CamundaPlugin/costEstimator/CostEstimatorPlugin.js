...
export default class CostEstimatorPlugin extends PureComponent {
    ...
    return (<Fragment>
      <Fill slot="toolbar">
        <button type="button" className="src-app-primitives-Button__Button--3Ffn0"
          title="Estimate costs for hybrid runtime group"
          onClick={() => { this.detectOptimizationCandidates(); this.setState({ adaptationOpen: true }); } }>
          <span className="hybrid-loop-adaptation"><span className="indent">Estimate costs</span></span>
        </button>
      </Fill>
