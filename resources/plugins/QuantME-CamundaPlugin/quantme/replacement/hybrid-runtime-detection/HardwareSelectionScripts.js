...
export var CUSTOM_ENVIRONMENT_SCRIPT='import groovy.json.*\n' 
;

export var INVOKE_POLICY_HANDLER_SCRIPT = 'import groovy.json.*\n' +
'\n' +
'def policyHandlerEndpoint = http://192.168.2.185:8889;\n' +
'def customEnvironmentPolicy = execution.getVariable("customEnvironment");\n' +
'def moneyPolicy = execution.getVariable("money");\n' + 'def privacyPolicy = execution.getVariable("privacy");\n' +'def availabilityPolicy = execution.getVariable("availability");\n' +
'def url = policyHandlerEndpoint + "/policy-handler/api/v1.0/detect-hybrid-runtime"\n' + 'def post = new URL(url).openConnection()\n'+
'def map = [availabilityPolicy: availabilityPolicy , customEnvironmentPolicy: customEnvironmentPolicy , moneyPolicy: moneyPolicy, privacyPolicy: privacyPolicy]\n'+
